...
for ifile to numberOfFiles
	...
	tmin = Get start time
	tmax = Get end time
	To Pitch (ac)... 0.004 'pitch_floor' 15 off 0.03 'voicing_threshold' 0.01 0.35 0.14 'pitch_ceiling'
	select Sound 'soundname$'
	To Intensity... 100 0 yes
	select Sound 'soundname$'
	To Formant (burg)... 0.004 'num_formant' 'max_formant' 0.025 50

for i to (tmax-tmin)/0.004
    time = tmin + i * 0.004
