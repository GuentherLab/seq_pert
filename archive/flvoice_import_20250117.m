%% this version incldues an addition by AM to look for JSON files to add to trialdata; 
% ...... we have replaced this approach by instead modifying the output of flvoice_import after it gets created
        ...
        if OPTIONS.OVERWRITE||~conn_existfile(filename_fmtData)
            for trialNum=modifytrials(:)'
                ...
                if OPTIONS.PRINT,
                    ...
                    hfig=figure('Visible',OPTIONS.SHOW_FIGURES); %%%%% added by AM and AK 2025/1/18
