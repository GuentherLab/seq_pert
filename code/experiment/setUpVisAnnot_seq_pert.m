...
% Pause annotation
annoStr.Pause = annotation(VBFig,'textbox', rdAnoPos,...
    'String',{'Press Spacebar when', 'you''re ready to resume'},...
    cSettings{:});
    annoStr.Pause.FontSize = 50; 
    annoStr.Pause.FitBoxToText = 'on'; % don't auto-wrap text
end
