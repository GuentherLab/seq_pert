function audapterDemo_online_modified_20230331(mode, varargin)
%% Configurations
...
switch stimInd
    ...
    case 3
        PCF_FILENAME = [FUNCTION_PATH filesep 'pcf_30down.txt'];
    case 4
        PCF_FILENAME = [FUNCTION_PATH filesep 'pcf_60down.txt'];
end
