...
paths_to_add = {dirs.projRepo;...
                ...
                [dirs.projRepo filesep 'AudDev' filesep 'code' filesep 'experiment'];...
                [dirs.projRepo filesep 'analysis' filesep 'mPraat-master'];... % interfaces Praat files with matlab
                [dirs.projRepo filesep 'util'];... % utility functions shared across projects, copied in this folder
                dirs.audapter_commonmcode;...
                dirs.spm;...
                dirs.conn;...
                dirs.FLvoice;...
